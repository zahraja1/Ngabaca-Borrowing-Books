            ...
            <div class="authentication">
                ...
                <form method="post" action="{{ route('register') }}">
                    ...
                    <div class="mb-3 inputan">
                        ...
                        @error('name')
                        <div id="name" class="form-text error invalid-feedback" role="alert">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3 inputan">
                        ...
                        @error('username')
                        <div id="username" class="form-text error invalid-feedback" role="alert">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3 inputan">
                        ...
                        @error('email')
                        <div id="email" class="form-text error invalid-feedback" role="alert">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3 inputan">
                        ...
                        @error('password')
                        <div id="passwod" class="form-text error invalid-feedback" role="alert">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3 inputan">
                        <label for="exampleInputPassword2" class="form-label">Konfirmasi Password</label>
                        <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" id="exampleInputPassword2">
                        @error('password_confirmation')
                        <div id="password_confirmation" class="form-text error invalid-feedback" role="alert">{{ $message }}</div>
                        @enderror
                    </div>
