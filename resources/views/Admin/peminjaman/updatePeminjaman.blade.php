                    ...
                    <form action="{{route('peminjaman.update', $peminjaman->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_peminjaman" class="form-control @error('kode_peminjaman') is-invalid @enderror" id="kode_peminjaman"
                                 placeholder="Masukkan kode_peminjaman peminjaman ...">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tanggal_peminjaman" class="form-control @error('tanggal_peminjaman') is-invalid @enderror" id="tanggal_peminjaman" 
                                placeholder="Masukkan tanggal_peminjaman peminjaman ...">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tanggal_pengembalian" class="form-control @error('tanggal_pengembalian') is-invalid @enderror" id="tanggal_pengembalian"
                                 placeholder="Masukkan tanggal_pengembalian peminjaman ...">
