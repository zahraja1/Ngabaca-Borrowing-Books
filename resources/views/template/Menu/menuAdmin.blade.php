            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('gendre.index')}}">Gendre</a>
                        <a class="collapse-item" href="{{route('buku.index')}}">Buku</a>
                        <a class="collapse-item" href="{{route('reservasi.index')}}">Reservasi</a>
                        ...
                        <a class="collapse-item" href="{{route('ulasan.index')}}">Ulasan</a>
                        <a class="collapse-item" href="{{route('index.chart')}}">Chart</a>
                    </div>
                </div>
            </li>
