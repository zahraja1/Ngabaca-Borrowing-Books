...
@section('title', 'Form Edit reservasi')
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{route('customer.update.reservasi', $reservasi->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div  class="card-body">
                        <div class="card-body">
...
<script>
    ClassicEditor
        .create(document.querySelector('#reservasi'))
        .catch(error => {
            console.error(error);
        });
</script>
