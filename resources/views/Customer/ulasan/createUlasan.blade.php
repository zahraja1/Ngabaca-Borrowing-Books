...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{route('customer.create.ulasan')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div  class="card-body">
                            <div class="form-group">
                                <label for="komentar">komentar</label>
                                <input type="text" name="komentar" class="form-control @error('komentar') is-invalid @enderror" 
                                id="komentar" placeholder="Masukkan komentar Buku ...">
                                @error('komentar')
                            ...
                            <div class="form-group">
                                ...
                                id="rating" placeholder="Masukkan Slug Buku ...">
                                @error('rating')
                                <div class="invalid-feedback">
                                    <strong>{{ $message}}</strong>
                                </div>
